...
class Application(Frame):
    ...
    def createWidgets(self):
        ...
        self.step2Frame.instruction = self.createInstructionTxt( self.step2Frame, "Insert an SD Card you wish to format with WifiPi." )
        ...
        self.step3Frame.instruction = self.createInstructionTxt( self.step3Frame, "Click Install to format this SD Card and install WifiPi." )
        ...
        self.step4Frame.instruction = self.createInstructionTxt( self.step4Frame, "WifiPi has been successfully installed. You may now remove your SD Card.\nFollow instructions at WifiPi.net to get started." )
    ...
    def step3( self, event=None ):
        ...
        self.step3Frame.instruction['text'] = "Click Install to format this SD Card and install WifiPi."
    ...
    def preStep4( self, event=None ):
        ...
        self.step3Frame.instruction['text'] = "Installing WifiPi on your SD Card."
        self.update_idletasks();
...
root.wm_title("WifiPi Install")
root.wm_client("WifiPi Install")
root.lift()
